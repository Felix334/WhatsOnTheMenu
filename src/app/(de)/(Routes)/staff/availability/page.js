  ...
  useEffect(() => {
    ...
    fetch(`/api/staff/availability/${restaurantID}`)
      .then(async (r) => {
        ...
        if (!r.ok) throw new Error(data.error || tc.loadError);
        return data;
      })
  ...
  if (!restaurantID) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <p className="text-gray-600">{tc.noRestaurantGiven}</p>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900">{ta.title}</h1>
                  ...
                  {cat.dishes.map((dish) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          {isUpdating ? "..." : isOut ? ta.available : ta.soldOut}
                        </button>
                      </li>
                    );
                  })}
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 max-w-md w-full text-center space-y-4">
          ...
          <p className="text-gray-500 text-sm">{ta.proHint}</p>
