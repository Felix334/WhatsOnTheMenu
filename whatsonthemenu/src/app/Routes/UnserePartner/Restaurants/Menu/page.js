...
//Name wird fehlerhaft angezeigt(Styles werden nicht angewannt)
  ...
  return (
    <div className="bg-gradient-to-br min-w-1xl from-yellow-50 via-yellow-100 to-yellow-200 flex flex-col items-center py-5">
      <header className="mb-12 text-center w-full">
        <h1 className="text-5xl font-serif font-semibold text-gray-900 tracking-wide"></h1>
        <p className="mt-2 text-gray-600 italic max-w-md mx-auto">{name}</p>
      </header>
      ...
      <div className="mt-4 text-xl">Gesamtpreis: {totalPrice.toFixed(2)}€</div>
    </div>
  );
}
