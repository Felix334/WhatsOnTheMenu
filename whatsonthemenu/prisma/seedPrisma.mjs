...
async function main() {
  ...
  const restaurant1 = await prisma.restaurant.create({
    data: {
      ...
      ownerId: owner1.id,
      menuID: "menu1", // Placeholder, will be updated after menu creation
      locations: {
        create: {
          street: "123 Main St",
          houseNumber: "1A",
  ...
  // Update restaurant1 with menuID
  await prisma.restaurant.update({
    where: { id: restaurant1.id },
    data: { menuID: menu1.id },
  });
  ...
  const restaurant2 = await prisma.restaurant.create({
    data: {
      ...
      ownerId: owner2.id,
      menuID: "menu2", // Placeholder, will be updated after menu creation
      locations: {
        create: {
          street: "456 Elm St",
          houseNumber: "2B",
  ...
  // Update restaurant2 with menuID
  await prisma.restaurant.update({
