  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-red-900 via-red-600 to-red-400 flex flex-col items-center justify-center text-white font-sans p-8">
      <header className="mb-12 text-center align-top leading-tight grid grid-col-1 gap-0 relative">
        <h1 className="text-2xl md:text-5xl font-bold mb-0 top-0 font-blue">
          Whats-On-The-Menu.de
        </h1>
        <p className="text-1xl md:text-3xl font-bold mb-0 ">
          Ihre visualisierte Speisekarte!
        </p>
        <p className="text-1xl md:text-3xl font-bold mb-0">
          Finden sie was sie wirklich essen wollen!
        </p>
        <div>
        ...
        <div className="fixed top-0 right-0 p-1 flex z-20">
          {userID && <Profile setUserID={setUserID} />}
        </div>
      </header>
        ...
        <section className="mb-6 grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] justify-center gap-4">
            ...
            <>
              <Card className="item-center grid gap-1">
                <CardHeader>
                  ...
                  <CardDescription>
                    Melde dich jetzt an um all unsere Funktionen benutzen zu
                    können
                  </CardDescription>
                </CardHeader>
                <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Finden sie herraus wer schon Teil unserer Community geworden
                ist.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <Button asChild>
                <Link
                  href={{
                    pathname: "/ErstelleRestaurantAccount",
                    query: {
                      ...router.query,
                      ...(userID ? { userID: userID } : {}),
                    },
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Hier einfach und schnell einen Tisch reservieren
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button asChild>
